...
$readHostMessage = "[Y] Yes, install graphics drivers  [N] No, skip"
$choicePrompt = "Would you like to install graphics drivers?"
$choiceIsYes = "Install-GPUDrivers"
yesOrNo
...
$readHostMessage = "[Y] Yes, run tweaks  [N] No, skip"
$choicePrompt = "Would you like to run tweaks to improve the Windows user experience?"
$choiceIsYes = @"
    runTweaks # function defined above or below or something
    TASKKILL.exe /F /IM explorer.exe
    Start-Process "$env:WinDir\explorer.exe"
    Write-Host "Tweaks done."
"@
yesOrNo

Clear-Host

# Set up "checkboxChecked" variables
$firefoxChecked = $false
$chromeChecked = $false
$steamChecked = $false
$discordChecked = $false
$epicGamesLauncherChecked = $false
$openRGBChecked = $false
$signalRGBChecked = $false
$vlcChecked = $false
$sevenZipChecked = $false
$malwarebytesChecked = $false
$furmarkChecked = $false
$hwmonitorChecked = $false
$msiafterburnerChecked = $false
$cinebenchChecked = $false
...
# margins
$textMargin = "Margin='0,0,0,10'"
$checkboxMargin = "Margin='0,0,0,10'"
